...
Un equipo de shooter competitivo revisa armas, munición y utilidad antes de entrar a ranked.
...
Filtrar armas disponibles, validar munición mínima y recomendar cargas de combate.

## Explicación paso a paso

1. Crea un arreglo de armas con nombre, tipo, municion y rareza.
2. Filtra las armas con municion mayor o igual a 30.
3. Separa rifles, pistolas y francotiradores.
...
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/logica/ejercicio-02/resoluciones/`.
