...
vehículos hiperdeportivos

## Contexto del problema

Un club de autos de lujo quiere clasificar vehículos por aceleración y exclusividad.
...
1. Define autos con marca, modelo, ceroACien, precioUSD y unidades.
2. Filtra los que hacen 0-100 en menos de 3 segundos.
3. Clasifica exclusividad: unidades < 500 es extrema.
4. Calcula precio promedio.
5. Muestra top 3 por aceleracion.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/logica/ejercicio-08/resoluciones/`.
...
Un auto con 250 unidades debe quedar como exclusividad extrema.
