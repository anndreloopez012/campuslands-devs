...
Una liga de fútbol sala necesita actualizar la tabla después de una jornada intensa.
...
1. Crea equipos con victorias, empates, derrotas, golesFavor y golesContra.
2. Calcula puntos = victorias * 3 + empates.
3. Calcula diferencia de goles.
4. Ordena por puntos y luego diferencia.
5. Imprime tabla con posicion.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/logica/ejercicio-05/resoluciones/`.
...
Un equipo 4V 1E 0D tiene 13 puntos.
