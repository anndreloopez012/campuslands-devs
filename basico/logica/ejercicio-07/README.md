...
Un mecánico recibe síntomas reportados por pilotos después de una carrera.
...
1. Crea una funcion diagnosticar(sintomas).
2. Evalua sintomas como 'no enciende', 'vibra', 'pierde aceite', 'frena poco'.
3. Devuelve una recomendacion por sintoma.
4. Permite varios sintomas en un arreglo.
5. Genera un reporte final.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu carpeta personal dentro de esta ruta: `basico/logica/ejercicio-07/resoluciones/nombre-apellido/`.
...
['vibra','frena poco'] puede sugerir revisar balanceo y pastillas.
