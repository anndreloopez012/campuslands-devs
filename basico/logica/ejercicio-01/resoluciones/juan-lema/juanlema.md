...
Desarrollador: Juan Lema
Módulo: Lógica Ejercicio 01
...
Trazabilidad de Operaciones Git
...
bash# Sincronización del entorno local con el árbol de desarrollo remoto
git checkout dev
git pull origin dev
...
git status
git add basico/logica/ejercicio-01/resoluciones/juan-lema/
