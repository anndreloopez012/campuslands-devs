...
Un torneo battle royale necesita ordenar escuadras por puntos, bajas y supervivencia.
...
Crear un programa que calcule el puntaje total de cada escuadra y genere un ranking ordenado.

## Explicación paso a paso

1. Usa un arreglo de objetos para guardar escuadras.
2. Cada escuadra debe tener nombre, bajas, posicion y revividos.
3. Calcula puntos: bajas * 3, top 1 = 20, top 2 = 14, top 3 = 10, otros = 4.
4. Ordena de mayor a menor puntaje.
5. Muestra el ranking con posicion, nombre y puntos.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/logica/ejercicio-01/resoluciones/`.
...
Entrada: [{nombre:'Nova', bajas:8, posicion:1, revividos:2}]. Salida esperada: 1. Nova - 44 pts.
