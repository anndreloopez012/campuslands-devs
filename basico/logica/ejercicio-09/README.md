...
Un gimnasio arma playlists por ronda para sesiones de kickboxing.
...
Organizar canciones por intensidad y duración total.

## Explicación paso a paso

1. Crea canciones con titulo, artista, bpm y duracionSeg.
2. Filtra canciones con bpm mayor a 135.
3. Agrupa por intensidad: media, alta, explosiva.
4. Suma duracion total.
5. Valida que la playlist dure entre 15 y 25 minutos.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/logica/ejercicio-09/resoluciones/`.
...
Una cancion de 150 bpm puede clasificarse como alta.
