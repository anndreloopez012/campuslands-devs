...
Un grupo planea una noche de películas y quiere balancear sustos, duración y calificación.
...
Seleccionar películas aptas para una maratón de máximo 6 horas.

## Explicación paso a paso

1. Define peliculas con titulo, duracionMin, sustos y rating.
2. Filtra rating mayor o igual a 7.
3. Acumula peliculas sin pasar 360 minutos.
4. Calcula total de sustos.
5. Muestra la lista final.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/logica/ejercicio-10/resoluciones/`.
...
Tres peliculas de 100, 110 y 120 minutos suman 330 minutos.
