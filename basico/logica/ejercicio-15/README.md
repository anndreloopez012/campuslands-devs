...
Un pequeño estudio necesita calcular costos de escenas, renders y artistas.
...
Calcular costo de producción por escena y detectar escenas costosas.

## Explicación paso a paso

1. Define escenas con nombre, horasModelado, horasRender y artistas.
2. Costo = horasModelado*40000 + horasRender*25000 + artistas*120000.
3. Filtra escenas con costo mayor a 1000000.
4. Calcula costo total del proyecto.
5. Muestra la escena más costosa.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/logica/ejercicio-15/resoluciones/`.
...
Una escena con 10h modelado, 8h render y 3 artistas cuesta 960000.
