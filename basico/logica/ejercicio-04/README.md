...
Evaluar jugadores por KDA, oro y control de objetivos.
...
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/logica/ejercicio-04/resoluciones/`.
...
Si deaths es 0, divide entre 1 para evitar errores.
