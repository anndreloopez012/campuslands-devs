...
Vas a simular una situación de trabajo colaborativo relacionada con viajes y turismo. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Escribir commits profesionales y legibles.

## Explicación paso a paso

1. Crea tres cambios pequeños.
2. Escribe commits con verbo claro.
3. Evita mensajes genéricos.
4. Lista los commits.
5. Evalúa si otro dev entendería el historial.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-12/resoluciones/`.
