...
Vas a simular una situación de trabajo colaborativo relacionada con animación 3D. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Resolver conflicto respetando trabajo de dos áreas.

## Explicación paso a paso

1. Simula dos ramas que editan estructura.md.
2. Una agrega modelado y otra agrega renders.
3. Genera conflicto.
4. Conserva ambas secciones.
5. Haz commit de resolución.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-13/resoluciones/`.
