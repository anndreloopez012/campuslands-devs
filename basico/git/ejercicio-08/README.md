...
Vas a simular una situación de trabajo colaborativo relacionada con música. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Simular y resolver un conflicto de texto.

## Explicación paso a paso

1. Crea dos ramas desde el mismo punto.
2. En ambas modifica la misma línea de playlist.md.
3. Fusiona una rama.
4. Intenta fusionar la segunda.
5. Resuelve el conflicto dejando una versión coherente.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-08/resoluciones/`.
