...
Vas a simular una situación de trabajo colaborativo relacionada con pingpong. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Fusionar una rama de trabajo hacia otra rama de integración.

## Explicación paso a paso

1. Crea rama feature/ranking-pingpong.
2. Haz un commit con ranking.md.
3. Regresa a dev local.
4. Ejecuta git merge feature/ranking-pingpong.
5. Valida el historial.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-07/resoluciones/`.
