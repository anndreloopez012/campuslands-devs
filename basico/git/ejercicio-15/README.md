...
ropa y proyectos reales

## Contexto del problema

Vas a simular una situación de trabajo colaborativo relacionada con ropa y proyectos reales. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Integrar ramas, commits, pull, push y revisión final.

## Explicación paso a paso

1. Crea rama desde dev.
2. Trabaja en una solución pequeña.
3. Haz commit claro.
4. Actualiza con dev antes de entregar.
5. Prepara checklist de entrega profesional.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-15/resoluciones/`.
