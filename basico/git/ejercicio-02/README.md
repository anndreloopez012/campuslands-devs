...
Vas a simular una situación de trabajo colaborativo relacionada con videojuegos RPG. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Practicar git clone y exploración inicial.

## Explicación paso a paso

1. Clona el repositorio indicado por el instructor.
2. Entra a la carpeta clonada.
3. Ejecuta git status.
4. Identifica rama actual.
5. Crea un archivo de notas con lo observado.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-02/resoluciones/`.
