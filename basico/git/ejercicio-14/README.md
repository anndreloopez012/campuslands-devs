...
Vas a simular una situación de trabajo colaborativo relacionada con fórmulas químicas. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Preparar una entrega como si fuera PR.

## Explicación paso a paso

1. Crea rama personal.
2. Agrega solución en resoluciones.
3. Haz commit.
4. Haz push.
5. Redacta descripción de PR con objetivo, cambios y validación.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-14/resoluciones/`.
