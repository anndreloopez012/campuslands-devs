# Commits pequeños de inventario battle royale
...
Vas a simular una situación de trabajo colaborativo relacionada con videojuegos battle royale. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Dividir cambios en commits lógicos.

## Explicación paso a paso

1. Crea un archivo inventario.md.
2. Primer commit: estructura del inventario.
3. Segundo commit: armas.
4. Tercer commit: curaciones y utilidad.
5. Revisa el historial con git log --oneline.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-04/resoluciones/`.
