...
Vas a simular una situación de trabajo colaborativo relacionada con películas y ciencia ficción. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Crear una rama secundaria basada en una feature.

## Explicación paso a paso

1. Crea feature/catalogo-sci-fi.
2. Desde esa rama crea feature/catalogo-sci-fi/posters.
3. Haz commits separados.
4. Fusiona primero la secundaria en la principal.
5. Luego fusiona la principal en dev local.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-09/resoluciones/`.
