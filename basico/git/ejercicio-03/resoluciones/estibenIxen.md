...
A continuación, se detalla el paso a paso técnico ejecutado en la terminal del sistema, historial de comandos realizados en la terminal.
  
*  git init 
*  git pull 
*  git branch
*  git branch estiben-ixen
*  git checkout estiben-ixen
*  git branch
*  git branch -m estibenixen-ejercicio-03
*  git branch
*  git status
*  cd git
*  cd ejercicio-03
*  touch basico/git/ejercicio-03/resoluciones-03/Estiben-ixen.md
*  touch basico/estructura/ejercicio-03/git/resoluciones/estiben-ixen.md
*  git pull dev
*  git pull
*  cd git
*  cd basico
