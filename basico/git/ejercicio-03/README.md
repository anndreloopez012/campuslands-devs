...
Vas a simular una situación de trabajo colaborativo relacionada con videojuegos MOBA. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Crear una rama desde dev y trabajar sin tocar main.

## Explicación paso a paso

1. Cambia a dev.
2. Actualiza con pull.
3. Crea rama alumno/nombre-apellido/ejercicio-03.
4. Agrega tu archivo en resoluciones.
5. Haz commit profesional.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu carpeta personal dentro de esta ruta: `basico/git/ejercicio-03/resoluciones/nombre-apellido/`.
