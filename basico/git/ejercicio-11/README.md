...
Vas a simular una situación de trabajo colaborativo relacionada con kickboxing. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Guardar trabajo temporal sin hacer commit incompleto.

## Explicación paso a paso

1. Modifica un archivo de entrenamiento.
2. Ejecuta git status.
3. Usa git stash.
4. Cambia de rama o simula otra tarea.
5. Recupera con git stash pop.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-11/resoluciones/`.
