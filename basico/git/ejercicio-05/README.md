...
Vas a simular una situación de trabajo colaborativo relacionada con motos. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
1. Confirma que estás en tu rama.
2. Haz commit de tu solución.
3. Ejecuta git push -u origin nombre-rama.
4. Verifica que la rama exista en GitHub.
5. Anota el enlace o evidencia.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-05/resoluciones/`.
