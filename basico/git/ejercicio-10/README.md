...
Vas a simular una situación de trabajo colaborativo relacionada con autos. Lo importante no es memorizar comandos, sino entender qué problema resuelve cada acción de Git.
...
Practicar git revert en una simulación controlada.

## Explicación paso a paso

1. Crea un commit agregando auto incorrecto.
2. Usa git revert para deshacerlo.
3. No uses reset.
4. Revisa git log.
5. Explica por qué revert conserva historial.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/git/ejercicio-10/resoluciones/`.
