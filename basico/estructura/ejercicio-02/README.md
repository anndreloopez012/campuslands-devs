...
Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con videojuegos MOBA. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Separar una interfaz simple para ranking de jugadores.

## Explicación paso a paso

1. Crea index.html, css/styles.css y js/app.js.
2. Agrega carpeta data con players.json.
3. Documenta cómo se conectaría cada archivo.
4. No mezcles estilos dentro del HTML.
5. Incluye una sección de notas técnicas.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/estructura/ejercicio-02/resoluciones/`.
