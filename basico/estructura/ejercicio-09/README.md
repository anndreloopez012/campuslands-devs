...
Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con tatuajes y dibujo. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Diseñar carpetas para referencias, diseños, clientes y agenda.

## Explicación paso a paso

1. Crea referencias, diseños, clientes y agenda.
2. Usa nombres sin espacios.
3. Agrega README.md explicando privacidad de datos.
4. Incluye plantilla de ficha de diseño.
5. No subas imágenes reales de clientes; usa placeholders.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/estructura/ejercicio-09/resoluciones/`.
