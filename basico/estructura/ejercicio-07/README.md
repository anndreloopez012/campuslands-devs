...
libros y ciencia ficción

## Contexto del problema

Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con libros y ciencia ficción. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Organizar una colección digital de libros por datos, portadas y reseñas.
...
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/estructura/ejercicio-07/resoluciones/`.
