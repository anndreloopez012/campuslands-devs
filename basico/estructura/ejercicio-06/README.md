...
Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con turismo. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Separar vistas, datos y lógica de una app de viajes.

## Explicación paso a paso

1. Crea pages, components, services y data.
2. Agrega data/destinos.json.
3. Crea components/card-destino.md como documentación de componente.
4. Explica cómo crecería el proyecto.
5. Valida que no haya nombres genéricos como cosas o varios.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/estructura/ejercicio-06/resoluciones/`.
