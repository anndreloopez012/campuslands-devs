...
├── pages/
│   └── listado-destinos.js      → Página que muestra el catálogo de destinos
├── components/
│   └── card-destino.md          → Documentación del componente CardDestino
├── services/
│   └── servicio-destinos.js     → Lógica: leer, filtrar y buscar destinos
└── data/
    └── destinos.json            → Catálogo de destinos (Antigua, Atitlán, Tikal)
```
