...
Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con música. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Separar canciones, samples, mezclas y documentación.

## Explicación paso a paso

1. Crea tracks, samples, mixes, masters y docs.
2. Agrega docs/versionado-audio.md.
3. Define una convención como cancion-v01.wav.
4. Crea README de proyecto simulado.
5. Explica por qué los masters no se mezclan con borradores.
