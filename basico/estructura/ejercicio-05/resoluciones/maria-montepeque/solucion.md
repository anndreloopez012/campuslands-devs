...
```
taller-motos/
├── index.js                          ← punto de entrada, muestra las órdenes válidas
├── modules/
│   ├── clientes/
│   │   ├── clientes.js               ← registro y consulta de clientes
│   │   └── README.md                 ← qué datos guarda el módulo
│   ├── motos/
│   │   ├── motos.js                  ← motos asociadas a un cliente
│   │   └── README.md                 ← qué datos guarda el módulo
│   └── ordenes/
│       ├── ordenes.js                ← crea, valida y resume órdenes
│       └── README.md                 ← qué datos guarda el módulo
├── docs/
│   └── flujo-reparacion.md           ← flujo completo de estados de una reparación
└── config/
    └── settings.example.json         ← configuración de ejemplo del taller
```
