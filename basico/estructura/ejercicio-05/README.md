...
Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con mecánica de motos. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Estructurar un proyecto para órdenes de reparación.

## Explicación paso a paso

1. Crea modules/clientes, modules/motos y modules/ordenes.
2. Agrega docs/flujo-reparacion.md.
3. Define un archivo config/settings.example.json.
4. Explica qué datos guarda cada módulo.
5. Evita archivos sueltos sin propósito.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/estructura/ejercicio-05/resoluciones/`.
