...
Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con videojuegos battle royale. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Diseñar carpetas de un backend que gestione partidas y equipos.

## Explicación paso a paso

1. Crea src/controllers, src/services, src/models y src/routes.
2. Agrega README.md en la raíz del proyecto simulado.
3. Explica qué responsabilidad tiene cada carpeta.
4. Crea un archivo de ejemplo por carpeta.
5. Mantén nombres descriptivos.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/estructura/ejercicio-03/resoluciones/`.
