...
Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con diseño 3D arquitectura. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Organizar planos, renders, materiales y documentación técnica.

## Explicación paso a paso

1. Crea planos, modelos, materiales, renders y docs.
2. Agrega docs/convenciones.md.
3. Define nombres para vistas como fachada-principal.
4. Separa borradores de finales.
5. Incluye una plantilla de entrega.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/estructura/ejercicio-11/resoluciones/`.
