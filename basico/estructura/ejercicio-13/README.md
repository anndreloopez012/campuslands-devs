...
Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con deportes y fútbol. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Organizar un proyecto que muestre equipos, partidos y tablas.

## Explicación paso a paso

1. Crea data/equipos, data/partidos, src y docs.
2. Agrega docs/modelo-datos.md.
3. Define archivos por liga.
4. Crea ejemplo de tabla.
5. Mantén carpetas preparadas para crecer.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/estructura/ejercicio-13/resoluciones/`.
