...
carreras y vehículos hiperdeportivos

## Contexto del problema

Un equipo técnico necesita preparar una base ordenada para un proyecto relacionado con carreras y vehículos hiperdeportivos. El reto consiste en demostrar que sabes organizar archivos como lo haría un proyecto real.
...
Organizar un simulador con pilotos, vehículos, pistas y resultados.

## Explicación paso a paso

1. Crea data/pilotos, data/vehiculos, data/pistas, src/simulador y docs.
2. Agrega ejemplo de vehículo.
3. Documenta reglas de carrera.
4. Separa configuración de resultados.
5. Valida que cada carpeta tenga propósito claro.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu archivo de respuesta dentro de esta carpeta: `basico/estructura/ejercicio-15/resoluciones/`.
