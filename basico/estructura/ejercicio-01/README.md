...
Organizar un proyecto de aventura con carpetas para código, assets y documentación.

## Explicación paso a paso

1. Crea carpetas src, assets, docs y tests.
2. Dentro de assets separa images, audio y maps.
3. Crea README.md explicando cada carpeta.
4. Agrega archivos .gitkeep donde una carpeta quede vacía.
5. Verifica que los nombres estén en minúscula.

## Instrucciones detalladas

- Trabaja en tu propia rama creada desde `dev`.
- Crea tu carpeta personal dentro de esta ruta: `basico/estructura/ejercicio-01/resoluciones/nombre-apellido/`.
